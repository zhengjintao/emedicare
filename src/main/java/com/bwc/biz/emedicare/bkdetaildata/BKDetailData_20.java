...
public class BKDetailData_20 {
	 ...
	 * 数据导入用构造函数
	 */
	public BKDetailData_20(Sheet sheet, String userid, String date, String histno) {
		this.sheet = sheet;
		this.userid = userid;
	...
	public List<String> getDateValue() {
		...
		String dataSql = "select context from cdata_detail_20 where userid = ? and examdate= ? and historyno= ? order by dispindex";
