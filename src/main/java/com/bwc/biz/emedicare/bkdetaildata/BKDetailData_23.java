...
public class BKDetailData_23 {
	...
	public BKDetailData_23() {}

	/*
	 * 数据导入用构造函数
	 */
	public BKDetailData_23(Sheet sheet, String userid, String username, String date, String histno) {
		this.sheet = sheet;
		this.userid = userid;
	...
	public void saveDataExcelToDb() {
		...
		String context = "";
		// 插入用SQL
		String insertSql = "insert into cdata_detail_23 value(?,?,?,?,?,?,?,?)";
	...
	public List<String> getDateValue(String userid, String historydate, String historyno) {
		...
		String dataSql = "select context from cdata_detail_23 where userid = ? and examdate= ? and historyno= ? order by dispindex";
	...
	public void deleteData(String userid, String historydate){
		...
		params[0]= userid;
		params[1]= historydate;
		String delsql = "delete from cdata_detail_23 where userid = ? and examdate = ?";
	...
	private void check(String userid, String date) {
		...
		String checksql = "select * from cdata_detail_23 where userid = ? and examdate = ?";
