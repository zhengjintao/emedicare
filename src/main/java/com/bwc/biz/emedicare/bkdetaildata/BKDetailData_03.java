...
public class BKDetailData_03 {
	...
	private List<int[]> indexList = Arrays.asList(
		...
		//尿沉渣检查
		new int[] {8,2},new int[] {8,5},new int[] {8,7},new int[] {8,8},new int[] {8,9},
		...
		//肾
		new int[] {12,2},new int[] {12,5},new int[] {12,7},new int[] {12,8},new int[] {12,9},
		...
		new int[] {19,3},new int[] {19,5},new int[] {19,7},new int[] {19,8},new int[] {19,9},
		new int[] {20,1},
		...
		new int[] {31,5},new int[] {31,7},new int[] {31,8},new int[] {31,9},
		new int[] {32,1}
	    );
