...
public class BKDetailData_22 {
	...
	public BKDetailData_22() {}

	/*
	 * 数据导入用构造函数
	 */
	public BKDetailData_22(Sheet sheet, String userid, String username, String date, String histno) {
		this.sheet = sheet;
		this.userid = userid;
	...
	public List<String> getDateValue(String userid, String historydate) {
		...
		String dataSql = "select context from cdata_detail_22 where userid = ? and examdate= ? order by dispindex";
	...
	public void deleteData(String userid, String historydate){
		...
		params[0]= userid;
		params[1]= historydate;
		String delsql = "delete from cdata_detail_22 where userid = ? and examdate = ?";
	...
	private void check(String userid, String date) {
		...
		String checksql = "select * from cdata_detail_22 where userid = ? and examdate = ?";
