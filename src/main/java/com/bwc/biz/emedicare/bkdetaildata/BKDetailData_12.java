...
public class BKDetailData_12 {
	 ...
	 * 数据导入用构造函数
	 */
	public BKDetailData_12(Sheet sheet, String userid, String date, String histno) {
		this.sheet = sheet;
		this.userid = userid;
	...
	public List<String> getDateValue() {
		...
		String dataSql = "select context from cdata_detail_12 where userid = ? and examdate= ? and historyno= ? order by dispindex";
