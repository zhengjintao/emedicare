...
<div class="ui bottom attached tab segment" data-tab="dtl20">	
	...
	<table class="ui unstackable celled structured table">
		<tbody>
			...
			<tr>
				<td colspan="4"><div class="ui input" style="height:30px;width:800px"> <input type="text" ng-model=list.dt_20[8]></div></td>
			</tr>
			<tr>
				<td class="cellheader" colspan="4">所见</td>
			</tr>
			<tr>
				<td colspan="4"><div class="ui input" style="height:30px;width:800px"> <input type="text" ng-model=list.dt_20[9]></div></td>
			</tr>
			<tr>
    		...
    		<tr>
			    ...
			    <textarea style="height: 50px; width: 100%; resize: none" ng-model=list.dt_20[10]></textarea>
		        </div>
		        </td>
			</tr>
		</tbody>
