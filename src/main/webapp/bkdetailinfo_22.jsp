...
<div class="ui bottom attached tab segment" data-tab="dtl22">	
	...
	<table class="ui unstackable celled structured table">
		<tbody>
			...
			<tr>
				<td colspan="4"><div class="ui input" style="30px;width:100px;"> <input type="text" ng-model=list.dt_22[8]></div></td>
			</tr>
			<tr>
				<td class="cellheader" colspan="4">所见</td>
			</tr>
			<tr>
				<td colspan="4"><div class="ui input" style="30px;width:100px;"> <input type="text" ng-model=list.dt_22[9]></div></td>
			</tr>
			<tr>
     			<td class="cellheader" colspan="4">诊断</td>
    		</tr>
    		<tr>
				<td colspan="4"><div class="ui input" style="30px;width:100px;"> <input type="text" ng-model=list.dt_22[10]></div></td>
			</tr>
		</tbody>
	</table>
</div>