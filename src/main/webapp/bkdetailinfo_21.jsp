...
<div class="ui bottom attached tab segment" data-tab="dtl21">	
	<h1 class="ui top header" style="margin-top: 11px; text-align: center">颈动脉超声波检查报告</h1>
	...
	<table class="ui unstackable celled structured table">
		<tbody>
			...
			<tr>
				<td colspan="4"><div class="ui input" style="height:30px;width:800px"> <input type="text" ng-model=list.dt_21[8]></div></td>
			</tr>
			<tr>
				<td class="cellheader" colspan="4">所见</td>
			</tr>
			<tr>
				<td colspan="4"><div class="ui input" style="height:30px;width:800px"> <input type="text" ng-model=list.dt_21[9]></div></td>
			</tr>
			<tr>
    		...
    		<tr>
			    ...
			    <textarea style="height: 50px; width: 100%; resize: none" ng-model=list.dt_21[10]></textarea>
		        </div>
		        </td>
			</tr>
		</tbody>
