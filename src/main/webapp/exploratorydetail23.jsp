...
app.controller('ListController', function($scope,$http,transFormFactory) {
	var list = this;
	  ...
	  <%for (int i = 0; i < dataList.size(); i++) {%>  
	       list.dt_23[<%=i%>] = "<%=StringUtil.javaScriptStringEnc(dataList.get(i))%>";
	   <%}%>
	  /* (function(){
...
<div class="ui bottom attached segment pushable">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="4">{{list.dt_23[8]}}</td>
    </tr>
    <tr>
      <td class="cellheader" colspan="4">所见</td>
    </tr>
    <tr>
      <td colspan="4">{{list.dt_23[9]}}</td>
    </tr>
    <tr>
      <td class="cellheader" colspan="4">诊断</td>
    </tr>
    <tr>
      <td colspan="4"><pre>{{list.dt_23[10]}}</pre></td>
    </tr>
  </tbody>
</table>
</div>
