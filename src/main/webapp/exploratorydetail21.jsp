...
app.controller('ListController', function($scope,$http,transFormFactory) {
	var list = this;
	  ...
	  /* (function(){
		  ...
		  var postdata = {'mode':'list', 'expid':list.expid, 'sheetid': '21'};
	      $http(
	  		{
	  			method:"POST",
	  			url:$scope.url,
...
<div class="ui bottom attached segment pushable">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="4">{{list.dt_21[4]}}</td>
    </tr>
    <tr>
      <td class="cellheader" colspan="4">所见</td>
    </tr>
    <tr>
      <td colspan="4">{{list.dt_21[5]}}</td>
    </tr>
    <tr>
      <td class="cellheader" colspan="4">诊断</td>
    </tr>
    <tr>
      <td colspan="4">{{list.dt_21[6]}}</td>
    </tr>
  </tbody>
</table>
</div>
